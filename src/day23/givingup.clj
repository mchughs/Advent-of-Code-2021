(ns day23.givingup
  "Using https://github.com/wevre/advent-of-code/blob/master/src/advent_of_code/2021/day_23.clj"
...
(def input {:A [:D :D] :B [:C :A] :C [:B :A] :D [:C :B]})

(def input-part2 {:A [:D :D :D :D] :B [:C :C :B :A] :C [:B :B :A :A] :D [:C :A :C :B]})
